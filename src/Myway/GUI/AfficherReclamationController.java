...
public class AfficherReclamationController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
     ...
     public void table() {
        reclamationTable.setItems(FXCollections.observableArrayList(sp.afficher()));
    ...
    private void filter(KeyEvent event) {
        ObservableList<Reclamation> filteredPeople = FXCollections.observableArrayList(sp.afficher());
